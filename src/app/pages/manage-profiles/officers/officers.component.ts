...
import { OfficersformComponent } from './officersform/officersform.component';
...
export class OfficersComponent {
 ...
 defaultcolumnName=['Frist Name','Destination','Contact']                 //column head name
  ...
  openWindowForm() {
    this.windowService.open(OfficersformComponent, { title: `Window` });
  }
